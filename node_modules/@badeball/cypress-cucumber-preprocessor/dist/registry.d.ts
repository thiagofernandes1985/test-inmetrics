...
export declare class Registry {
    ...
    resolveStepDefinition(text: string): IStepDefinition<unknown[], Mocha.Context>;
    runStepDefinition(world: Mocha.Context, text: string, dryRun: boolean, argument?: DataTable | string): unknown;
